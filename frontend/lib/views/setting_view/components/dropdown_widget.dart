...
class DropdownWidget extends StatefulWidget {
  const DropdownWidget(
      {super.key, required this.values, required this.initValue, this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<LevelOfDifficulty>(
          ...
          return PopupMenuItem(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: value == widget.values.first ? 10 : 0,
                  )
                ],
              ));
        }).toList();
      ...
      child: Container(
        ...
        constraints:
            const BoxConstraints(minHeight: 37, minWidth: 123, maxWidth: 123),
        ...
        child: Row(
          ...
          children: [
            Text(
              GameSettingConsts
                  .personalLevelOfDifficultyText[widget.initValue]!,
